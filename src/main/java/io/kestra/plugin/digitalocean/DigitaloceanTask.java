    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.digitalocean.DigitaloceanTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class DigitaloceanTask extends Task implements RunnableTask<DigitaloceanTask.Output> {
    @Schema(
    ...
    @Override
    public DigitaloceanTask.Output run(RunContext runContext) throws Exception {
