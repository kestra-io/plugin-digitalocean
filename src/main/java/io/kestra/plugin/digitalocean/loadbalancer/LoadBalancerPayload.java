...
final class LoadBalancerPayload {
    ...
    static Map<String, Object> build(String name, String region, List<Map<String, Object>> forwardingRules, List<Long> dropletIds) {
        var payload = new LinkedHashMap<String, Object>();
        payload.put("name", name);
        payload.put("region", region);
        payload.put("forwarding_rules", forwardingRules);
